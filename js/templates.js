function showHelpFirstPage() {
    return /*html */ `
        <div class=" d-flex justify-content-center align-items-center gapHelp" >
            <img class="closeImg position-absolute" src="img/10_extras/close.svg" alt="">
            ...
            <button class="position-absolute nextBtn d-flex justify-content-center align-items-center">Next</button>
        </div>            
    `;
}
...
function showHelpSecondPage() {
    return /*html */ `
        <div class=" d-flex justify-content-center align-items-center gapHelp" >
            ...
            <button class="position-absolute nextBtn d-flex justify-content-center align-items-center">Next</button>
            <button class="position-absolute backBtn d-flex justify-content-center align-items-center">Back</button>
        </div>                
    `;
}
